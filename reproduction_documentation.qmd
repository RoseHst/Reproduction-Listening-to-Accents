...
Here, we focus on the intelligibility data. It represents the transcription performance of the EFL learners when listening to each accent (measurement: accuracy, so whether the word was correctly or falsely transcribed). We convert the character variable "Accent" to factor to get its levels.
...
Descriptive statistics (Min, Max, Median, Mean, Standard Deviation, Interquartile Range)
...
Interaction of Comprehensibility and Accentedness (correlation) (?)
...
Plot relative frequencies (proportional):
